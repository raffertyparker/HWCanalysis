...
```{r randomWalk, out.width='100%', fig.cap="Actual electricity use and random walk model approximation over one day"}
knitr::include_graphics(paste0(pFile, "randomWalk/rf06RW.pdf"))
```
