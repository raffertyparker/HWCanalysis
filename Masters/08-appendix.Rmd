...
It can be seen that many households have optimal lags greater than one hour. To reduce computatonal time and model complexity, only half-hour and one-hour lags were considered in this analysis. Household-specific lag values of external regressors could be incorporated into the model as further work.
