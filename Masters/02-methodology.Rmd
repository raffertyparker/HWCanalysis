...
Due to their simplicity and ease of computation they are also used in forecasting as a 'benchmark' model, by which other models may be compared. For this reason, they are referred to as 'naïve' models.
