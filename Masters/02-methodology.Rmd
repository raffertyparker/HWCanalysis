...
_Need to broadly describe different approaches - it's fine to introduce ARIMA first then introduce AR, MA and random walks as special cases of ARIMA, these models will be restated (with model parameters) in results chapters_
...
## Introduction to methods and models used

This section outlines a broad introduction to the various models used.
