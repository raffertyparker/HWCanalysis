...
```{r averagePlot, out.width='100%', include=FALSE, fig.cap="Average daily demand of hot water electricity for each household"}
knitr::include_graphics(paste0(pFile, "averageDemand.pdf"))
```
