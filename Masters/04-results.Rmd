...
```{r linearRelations, out.width='100%', echo=FALSE, fig.cap="Linear relation between non hot water electricity and half-hour lagged hot water electricity for household rf_06"}
knitr::include_graphics(paste0(pFile, "rf_13LinearPlot.pdf"))
```
