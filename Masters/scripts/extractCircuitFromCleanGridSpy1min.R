...
dateFrom <- "2014-01-01" # change this to change the (inclusive) UTC date to search from
dateTo <- "2018-12-31" # change this to change the (inclusive) UTC date to search to
...
if(localData == 1){
  ...
  iPath <- "~/HWCanalysis/Masters/powerData/" # downloaded from https://dx.doi.org/10.5255/UKDA-SN-853334
