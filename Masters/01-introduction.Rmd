...
_THIS NEEDS TO BE MUCH LONGER, and paint a more clear picture of the 'problem' I am trying to solve_

Total electricity demand varies throughout time, with average daily demand patterns in New Zealand generally exhibiting two peaks, one in the morning and one in the evening[@TranspowerNZ2015]. In addition, times of extreme weather or social factors can cause (often localised) extreme demand fluctuations, sometimes causing significant disruption to networks _elaborate and cite_.

_Need to distinguish between local network and national peaks, as well as daily peaks from extreme events and seasonal peaks_ 
...
Demand side management (DSM) is the process of adjusting demand to meet supply, and may play a vital role in the transition to a low-carbon electricity grid. 
_Discuss current DSM practices including instantaneous reserves markets here_

_Now introduce IOT and smart control here_
...
In addition to assisting DSM objectives, smart control of hot water cylinders can improve their efficiency by only heating as much water as is required by the household.
...
This method is far less computationally expensive to train than ANNs, and research interest in the context of electricity demand forecasting is still growing, as can be seen in Figure \@ref(fig:SVMinDF).
...
_Include a subsection on metrics here_
...
_Add forecast length to each paper_
