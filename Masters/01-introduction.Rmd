...
Forecasting period can be further seperated into three catagories[@MatDaut2017]. Short term forecasting is for predictions less than one week in advance, medium term is for predictions between one week and one year, and long term, which is for predictions spanning longer than one year.
...
Artificial Intelligence (AI) methods are those that use more complex techniques such as artificial neural networks (ANN) or support vector machines (SVM) to make predictions.
