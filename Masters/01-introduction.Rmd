...
_Do I still need to distinguish between local network and national peaks, as well as daily peaks from extreme events and seasonal peaks?_ 
...
Demand side management (DSM) is the process of adjusting demand to meet supply, and may play a vital role in the transition to a low-carbon electricity grid. Many electricity using devices can have their use times shifted on a daily scale with limited impact to the end user (a property referred to as "flexibility"). Devices such as washing machines and dishwashers exhibit this property, along with battery storage systems in the form of electric cars and bicycles, and thermostatically controlled appliances including heat pumps, as well as the focus of this thesis, electric hot water cylinders (HWCs).
The ability of the HWC to store and retain up to 10kWh of energy in the form of heat renders them perfect candidates for DSM, and could be considered one of the most “flexible” appliances in New Zealand households[@Stephenson2017].

## Why predict hot water electricity demand

The ability to predict usage patterns allows hot water cylinder elements to be controlled according to the usage patterns of individual houses. This is beneficial for demand side management objectives, and can also facilitate improvements in energy efficiency.

### Enhancing control for DSM objectives

Due to domestic electricity consumption patterns corresponding to appliance usage soon after waking in the morning, and soon after returning home in the evening, residential electricity demand is a key contributor to network demand peaks.
...
_Include MCMC? a couple of papers utilise it but I believe it's better suited to modelling/scenarios than forecasts and I won't be using it_
...
```{r ANNinDF, include=FALSE, out.width='100%', fig.cap="Documents in SCOPUS containing keywords: artificial AND neural AND network AND electricity AND demand AND forecasting"}
...
There is a large and active body of research that explores different methods of controlling demand-flexible appliances under various demand side management objectives. While some involve forecasting of electricity prices, appliance-level demand forecasting is still relatively sparse in the academic literature. This section is broadly separated into two parts. The first describes literature around control of appliances for efficiency gains or demand side management, the second describes literature around electricity demand forecasting.

### Control for efficiency gains or DSM objectives

_The following simply lists articles. I may need to catagorise and order a bit more. In addition, some may need to be discarded, in particular those that control appliances other than HWCs, and have no forecasting component. Others possibly need simplifying, or otherwise have uncommon terms introduced prior to this section. In particular, it might be best to just describe ARIMA methods in terms of "conventional time series" etc rather than name them explicitly_
...
### Forecasting to improve control objectives
...
As this thesis is concerned only with short term forecasts, no literature relating to medium or long term forecasts is included.
