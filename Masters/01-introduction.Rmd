...
One conventional forecasting method utilises data of separate but related (explanatory) variables and makes predictions based on basic statistical relationships between them. This is known as regression analysis, and may be utilised for time series forecasting in the following manner:
...
In the context of electricity demand forecasting, relevant predictable independent variables may be things such as public holidays, or (accurately forecasted) weather conditions[@Wei2018].
...
_Include MCMC? a couple of papers utilise it but I believe it's better suited to scenarios than forecasts_
...
These methods can be considered separate from their conventional counterparts by their ability to process and establish relationships between data in a more autonomous fashion, relying on algorithms and large amounts of computational power as opposed to the statistics and human intuition required for conventional forecasting.
While AI methods now generally obtain more accurate predictions than conventional methods[CITE], their computational expense can be a hindrance to large-scale adoption, as it generally involves a time-consuming process using expensive and energy-intensive computers.
Despite this, utilising machine learning for the purpose of electricity demand forecasting is a vast and highly active research area.
