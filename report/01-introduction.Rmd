...
This suitability of forecasting parameters for inputs into demand simulations is examined in more detail in Chapter \@ref(lit-rev).
...
The research conducted for this thesis uses electricity demand time series data that has been previously collected from New Zealand households[@R-GREENGridData].
