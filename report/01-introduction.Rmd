...
Local network companies (also known as electricity distribution businesses) are in charge of transmitting electricity from the grid nodes to individual households, and charge retailers a fixed charge per kWh of electricity delivered for the service[@Stephenson2018].
...
## Increasing energy efficiency {#enEfficiencyIntro}
