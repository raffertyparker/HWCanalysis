...
The introduction in this chapter explained two key inefficiencies that forecasting of hot water electricity demand could help alleviate. It also provided a brief introduction to the type of data and techniques used to make these forecasts.
The following chapter is the Literature review. This highlights key research in relevent topics, in particular, hot water modelling, smart control of appliances, and electricity demand forecasting.
The methodology is provided in Chapter \@ref(methodology). This chapter introduces the electricity demand dataset utilised in this work, and explains the data cleaning and preparatory process. It goes on to introduce the exploratory data analysis techniques and the forecasting models utilised in this research, and describe the metrics by which the models are compared to one another.
_SPLIT RESULTS CHAPTERS_
