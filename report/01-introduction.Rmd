...
Thus ripple control (or a similar system) could be personalised to individual household usage patterns, with intelligent control systems including predicted demand in their algorithms.
...
## Hot water demand simulations

Smartly controlling residential hot water cylinders is an active research topic. Much of this research uses computer models that replicate a hot water cylinder and its operation under standard residential hot water demand patterns.
...
A selection of time series analysis, causal, and AI forecasting methods will be explored and compared against one another. Comparative metrics take into consideration both the suitability for incorporation into smart control systems, and for incorporation as demand simulation into physical models.
