...
_Problem with mismatched temporal electricity needs to be eleborated on_
_Why would we want to predict hot water demand? DSM and efficiency. Both need to be introduced_

Temporal variation in electricity demand occurs at a variety of timescales in an electricity grid. As electrical energy cannot be stored, electricity supply must match this fluctuating demand in order to avoid large-scale damage to electricity-using appliances that operate under specific alternating current (AC) frequencies.
...
Ensuring that there is enough capacity to provide electricity at times of very high demand or during unexpected grid emergencies requires the building and maintenance of underutilised generation and transmission infrastructure, a costly and inefficient situation[@Strbac2008]. 
