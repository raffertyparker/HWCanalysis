...
Refs [@Cui2016], [@Denis2019], [@Lomet2015] and [@Popescu2016] also use some variation or ARIMA modelling for electricity demand forecasting.
...
Gajowniczeka and Ząbkowski (2014)[Gajowniczek2014] compare ANN and SVM forecasting methods to forecast aggregate household demand over 24 hour periods. Both models displayed similar performance in accuracy, however no comparison of computational expense was made.

Ahmad, Hassan, Abdullah, Rahman and Hussin (2014) also compared ANNs and SVMs, as well as some conventional forecasting techniques, for building-level electricity demand forecasting. They concluded that the AI methods outperformed conventional methods in accuracy, with SVM models generally outperforming ANNs. No comparison on computational expense was provided.

Jain and Satish (2009)[Jain2009] used SVMs to forecast grid-level electricity demand. While ANNs were mentioned for their prevalence in electricity demand forecasting, SVMs were ultimately chosen as the forecast method for their generalisation, performance, and automatic model parameter selection capabilities.

_Markov chain forecasting literature have been excluded as markov chains not previously introduced and not explored further_
