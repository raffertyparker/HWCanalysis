...
Temporal variation in electricity demand occurs at a variety of timescales in an electricity grid. As electrical energy cannot be stored, electricity supply must match this fluctuating demand. Providing electricity at times of very high demand requires the building and maintanence of underutilised generation and transmission infrastructure, a costly and inefficient situation[@Strbac2008]. 
...
The grid benefits in being able to rapidy increase generation or decrease load is reflected by the ability to monetize this capacity through various electricity markets.
...
Large electricity users are often provided a discounted kWh price of electricity, while being charged high penalties for any electricity consumed during times where there is extreme local network demand (known as 'congestion periods')[@Orion2017].
...
Conventional forecasting techniques are generally prized for being simple and interpretable, while taking minimal computing resources, but often require significant human input and tend to be outperformed in regards to accuracy by more advanced methods, such as artificial intelligence.
...
_Too many unfamiliar/unintroduced terms in here._
...
Refs [@Cui2016] and [@Denis2019] also use some variation or ARIMA modelling for short term electricity demand forecasting at individual household level.

After confirming the importance of accurate DHW forecasts for effective demand response, the authors in [@Lomet2015] propose the use of an ARMA model fitted to household level volumetric DHW consumption data for this purpose.  
...
[@Popescu2016] uses an ARMA model for forecasting day-ahead hot water consumption of a block of 60 apartments under a district heating system.
