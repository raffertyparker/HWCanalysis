...
Having a large tank of water being maintained at 65°C day and night, while only a portion of it is being used at particular times of day or week for the vast majority or the time, is thermally inefficient.
...
_Too many unfamiliar/unintroduced terms in here. Need to either briefly introduce tnew terms in terms of old ones i.e "ARIMA, a time series method..."
...
There are a number of key gaps in the literature around demand forecasting for smart control purposes that I hope to fill with this thesis.
While much work exists on forecasting demand down to household level, academic literature concerned with demand forecasting at the level of individual hot water cylinders is sparse. For that which does exist, much of it uses volumetric data, as opposed to electricity demand data. I encountered none that focussed on predicting demand for only the next half hour, with most forecasting 24 hours ahead. Few used data at half hour resolution, the current resolution of New Zealand smart meter data. I encountered none that utilised the electricity demand of other appliances as an external regressor. Finally, very few were concerned with any metrics except for accuracy.
