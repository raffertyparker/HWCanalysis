...
The literature relevant to this thesis may best be considered as falling somewhere within three separate but overlapping categories: smart control of appliances, demand forecasting, and hot water cylinder modelling. _Make sure these three topics have separate sections_
...
_Consider adding diagram of physical HWC model_
...
knitr::include_graphics(paste0(pFolder, "gelazanskasComparison.pdf"))
```
