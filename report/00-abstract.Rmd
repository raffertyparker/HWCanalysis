...
This was averaged over half-hour periods to mimic data currently available from smart meters in New Zealand, and then seperated according to date into 'training' and 'validating' sets.
...
Of the models selected for development and comparison, support vector machines provided the most accurate forecasts.
A model incorporating seasonal decomposition with local polynomial regression and autoregressive integrated moving averages also provided reasonable accuracy, while outperforming support vector machines in other metrics.
