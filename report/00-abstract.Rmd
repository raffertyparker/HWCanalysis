...
The most complex conventional model incorporated STL with ARIMA while including other electricity demand as an external regressor. This performed almost as well as the SVMs in accuracy, while also performing reasonably well in other metrics, and would be the recommended model for use in smart control.
