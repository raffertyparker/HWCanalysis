...
```
-->
```{r load30minHouse, eval = FALSE, include=FALSE}
...
if (!exists("dFolder")){
  dFolder <- "~/HWCanalysis/Masters/data/" 
}
...
#load(paste0(dFolder, "models/randomWalk/procTime.Rda"))
#load(paste0(dFolder, "models/randomWalk/sdResRW.Rda"))
```
