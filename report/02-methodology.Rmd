...
In a similar manner to the naive model, the seasonal naive model makes a prediction from a single prior obesrvation.
...
For data that displays weekly seasonality, for eample that of residential electricity demand, a seasonal naive model would predict that hot water demand is the same as it was the same time one week prior.
