...
As this work is concerned with predictability and patterns within our data over time, we extensively utilise time series data analysis methods. The book "Introductory Time Series With R"[@Cowpertwait2009] provided a guideline to the overall process.
...
The effect of this smoothing may be seen by comparing Figure \@ref(fig:elementPlot) with Figure \@ref(fig:hhElementPlot).
...
Data processing code can be viewed at `https://github.com/raffertyparker/HWCanalysis/blob/master/scripts/processing.R`.
