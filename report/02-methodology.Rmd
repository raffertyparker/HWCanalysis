...
knitr::include_graphics(paste0(pFolder, "prelim/allHousesNoHolesRemoved.png"))
```

```{r prelimHolesRemoved, out.width='100%', fig.cap="Overview of data after cleaning process"}
knitr::include_graphics(paste0(pFolder, "prelim/allHousesAfterRemoval.png"))
```
...
The STL method was developed by Cleveland, Cleveland, McRae, & Terpenning (1990)[@Cleveland1990], with the decomposition algorithm provided in the reference.
_Do I need to expand upon this?_
...
ARIMAX (ARIMA with eXternal regressor) models utilise both time series and causal methods by including an explanatory variable (in our case, other appliance electricity demand) as a regressor within an ARIMA model.

_Cite, include equation_
