...
knitr::include_graphics(paste0(pFolder, "prelim/allHousesHolesRemoved.png"))
```
...
```{r headDT, message=FALSE, fig.cap="Example of the clean and processed data used in the analysis"}
knitr::kable(DThead, "latex")
```
...
```
Figure \@ref(fig:STLPlot) illustrates an STL decomposition of a household over two weeks. The top panel, labelled 'observed', is the actual data. The 'trend' panel 
<!--
