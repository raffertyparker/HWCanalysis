...
Another mechanism by which to incorporate cyclic effects into ARIMA models is through STL decomposition (see \@ref(STL)). A time series may be split into seasonal and trend components, with the remainder being fed into the auto.arima model.
